...
Transaction.prototype.prepareMessageHash = function(privateKey, sigtype, jcardBuf) {
  ...
  _.each(this.getSignatures(privateKey, sigtype, jcardBuf), function(signature) {
...
Transaction.prototype.getSignatures = function(privKey, sigtype, jcardBuf) {
